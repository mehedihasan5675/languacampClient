          ...
          <ul className="menu p-4 w-80 h-full bg-[#A9907E]   uppercase text-white font-semibold tracking-wider">
            {/* Sidebar content here */}
            {
              ...
              <ActiveLink to="/dashboard/mySelectedClass"><FaHome className="text-yellow-400"></FaHome> My Selected Classes</ActiveLink>
               <ActiveLink to="/dashboard/enrolled"><FaHome className="text-yellow-400"></FaHome>My Enrolled Classes</ActiveLink> 
              
              <ActiveLink to="/dashboard/paymentHistory"><FaWallet className="text-yellow-400"></FaWallet> Payment History </ActiveLink>
            </li>
