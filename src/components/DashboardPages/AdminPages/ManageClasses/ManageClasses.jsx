        ...
        <div className="overflow-x-auto w-full px-5">
          <table className="table">
            ...
            <tbody>
              {/* row 1 */}
             {
                allClasses?.map((cls,i)=> <tr key={cls._id}>
                <th>
                    {i+1}
                </th>
                    ...
                    <th >
                      ...
                      <button onClick={()=>handleApproveBtn(cls) }className="btn  btn-outline  btn-ghost  btn-xs"> Approve</button>
                      </div>

                      <div  className="flex gap-8">
                      <button onClick={()=>handleDenyBtn(cls) } className="btn btn-outline btn-ghost  btn-xs"> Deny</button>
                      </div>
                       </div>
                    </th>
                  </tr>)
